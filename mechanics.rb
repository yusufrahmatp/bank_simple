...
def add_balance(noacc)
  ...
  @acc_data[noacc][:balance]+=@addbalance
  ...
  if (@cur_acc.nil?)
    ...
    loop do
      ...
      loop do
        ...
        break if @input2=="freeze"||@input2=="check"||@input2=="add"||@input2=="withdraw"||@input2=="edit"||@input2=="logout"||@input2=="exit"
        puts "Invalid input"
      end
      case @input2
      when "check"
